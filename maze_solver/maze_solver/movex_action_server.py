...
class MoveXActionServer(Node):
    ...
    def __init__(self):
        ...
        # initialize variable to store the current time as starting time 
    ...
    def odom_callback(self, msg):
        # update the value with each new msg
        self.last_odm_time = self.get_clock().now()
    ...
    def execute_callback(self, goal_handle):
        ...
        start_X = self.get_clock.now()
        # store starting time value to calculate "time out"
        ...
        while rclpy.ok() and (abs(self.current_x - start_x) < target_distance):
            ...
            last_time_odm_Msg=(current_time - self.last_odm_time).nanosecond/1e9 #convert to sec
            ...
            ### EDGE CASE "Time Out"
             passed_time = (current_time - start_time).nanosecond /1e9
...
if __name__ == '__main__':
    main()
>>>>>>> f9a72e9b13eb584f757767b377c2c04792a603d3
